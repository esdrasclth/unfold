...
mod catalogo;
mod publicar;
pub use catalogo::{Catalog, ConnectedRepository, RepositoryEntry};
use publicar::{publish, sync_and_push};
use catalogo::{
    describe, entry_of, guard, local_root, now, read_catalog, touch, upsert, write_catalog,
};
...
#[cfg(test)]
mod tests {
    use super::catalogo::{catalog_path, CATALOG_FILE};
    use super::*;
